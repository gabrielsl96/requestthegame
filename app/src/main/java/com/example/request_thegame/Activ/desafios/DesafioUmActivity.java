...
public class DesafioUmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_desafio_um);
        ...
        cronometro=findViewById(R.id.text_cronometro);
       btnResposta=findViewById(R.id.btn_resposta);

       cronometro.setText(String.valueOf(tempo));

       resolução = new AlertDialog.Builder(DesafioUmActivity.this);
        ...
        btnResposta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!respostaUm.isChecked()
                    ...
                    Toast.makeText(DesafioUmActivity.this,
                    ...
                    if (perguntas.size() >= 1) {
                        ...
                        if (acertos == quantidadePerguntas) {
                            ...
                            reference.child("Desafios")
                                    ...
                                    .child("statusDesafio")
                                    .setValue("Concluído primeiro desafio");
                            ...
                            resolução.setTitle("Parabéns!!!")
                                    .setMessage("Você conseguiu realizar o desafio!!")
                                    .setCancelable(true)
                                    .setOnCancelListener(new DialogInterface.OnCancelListener() {
                                        @Override
                                        public void onCancel(DialogInterface dialog) {
